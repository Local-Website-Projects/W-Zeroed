    ...
    $messege = "<html>
     ...
     <div style='max-width: 600px; min-width: 200px; background-color: #ffffff; padding: 20px; margin: auto;'>
         ...
         <div style='color:black;text-align: left'>
             ...
             <p>If you want to verify this job experience please click on the following verify button: <a href='Job-Experience-Verification?id={$job_id}' target='_blank'>Verify</a></p>
         </div>
     </div>
