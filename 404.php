    ...
    <body>
        <div class="error flex items-center justify-center w-screen h-screen">
            <div class="container flex max-xl:flex-col items-center justify-between gap-y-8">
                <img src="assets/images/components/error.png" alt="components/error" class="flex-shrink-0 xl:w-[55%] max-xl:max-h-[40vh] w-auto" />
                <div class="content w-fit">
                    ...
                    <a href="Login" class="button-main mt-6">Back To Homepage</a>
                </div>
            </div>
        </div>
