            ...
            <li class="nav_item py-2">
                ...
                <div class="sub_nav_mobile">
                    ...
                    <div class="list-nav-item w-full pt-2 pb-6">
                        <ul>
                            <li class="nav_item">
                                <a href="Home" class="inline-block text-xl font-semibold py-2 capitalize"> Home Freelancer 01 </a>
                            </li>
                            <li class="nav_item">
                ...
                <div class="sub_nav_mobile">
                    ...
                    <div class="list-nav-item w-full pt-2 pb-6">
                        <ul>
                            ...
                            <li class="nav_item">
                                <a href="Login" class="inline-block text-xl font-semibold py-2 capitalize active"> Login </a>
                            </li>
                            <li class="nav_item">
